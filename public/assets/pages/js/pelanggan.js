$(document).ready(function () {
    ...
    function getPelanggan() {
        ...
        if ($('#pelangganTable').length > 0) {
            tableCustomer = $('#pelangganTable').DataTable({
                ...
                ajax: {
                    url: `/admin/pelanggan/getPelanggan`, // Ganti dengan URL endpoint server Anda
    ...
    $(document).on("click", ".btn-edit", function () {
        ...
        $.ajax({
            url: `/admin/pelanggan/getPelangganByID/${pelangganID}`, // Endpoint untuk mendapatkan data pegawai
            type: "GET",
            success: function (response) {
                // Ambil data pertama
    ...
    $(document).on("submit", "#formEditPelanggan", function (e) {
        ...
        $.ajax({
            url: `/admin/pelanggan/updatePelanggan/${idPelanggan}`, // URL untuk mengupdate data pegawai
    ...
    $(document).on("click", ".confirm-text", function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                fetch(`/admin/pelanggan/deletePelanggan/${deleteID}`, {
                    method: "DELETE",
                    headers: {
