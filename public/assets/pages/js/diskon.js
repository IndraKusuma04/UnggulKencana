$(document).ready(function () {
    ...
    function getDiskon() {
        ...
        if ($('#diskonTable').length > 0) {
            tableDiskon = $('#diskonTable').DataTable({
                ...
                ajax: {
                    url: `/admin/diskon/getDiskon`, // Ganti dengan URL endpoint server Anda
    ...
    $("#formTambahDiskon").on("submit", function (event) {
        ...
        $.ajax({
            url: "/admin/diskon/storeDiskon", // Endpoint Laravel untuk menyimpan pegawai
            type: "POST",
            data: formData,
    ...
    $(document).on("click", ".btn-edit", function () {
        ...
        $.ajax({
            url: `/admin/diskon/getDiskonByID/${diskonID}`, // Endpoint untuk mendapatkan data pegawai
            type: "GET",
            success: function (response) {
                // Ambil data pertama
    ...
    $(document).on("submit", "#formEditDiskon", function (e) {
        ...
        $.ajax({
            url: `/admin/diskon/updateDiskon/${idDiskon}`, // URL untuk mengupdate data pegawai
